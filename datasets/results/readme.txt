Note:
-------------------------------------------------------------------------------------
Since the healthcare datasets used in the paper/thesis cannot be distributed with this software, we included the results of an offline evaluation using a couple of public multiclass datasets.
The latter were selected by the number of attributes and, less strictly, the attributes having to do with some sort of physical measurement:
...
-------------------------------------------------------------------------------------
distribute_<timestamp>_<new or resume>.log: log file of the Celery-based evaluation engine
...
-------------------------------------------------------------------------------------
The files follow the same structure above.
There are several distribute*.log files because the process was resumed after disruptions in the computational infrastructure we were using, with no prejudice to the results.
